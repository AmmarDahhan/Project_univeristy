...
Route::post('/orders' , [WarehouseOwner::class , 'orders_show']);
Route::post('/order_modify' , [WarehouseOwner::class , 'order modify']); // Query string and Request Body are required
